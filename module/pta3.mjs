...
import { ptaActorSheet } from './sheets/actor-sheet.mjs';
...
Hooks.once('init', function () {
  ...
  Actors.registerSheet('pta3', ptaActorSheet, {
    makeDefault: true,
    label: 'PTA.SheetLabels.Actor',
  });
  Items.unregisterSheet('core', ItemSheet);
  Items.registerSheet('pta3', ptaItemSheet, {
    makeDefault: true,
    label: 'PTA.SheetLabels.Item',
  });
